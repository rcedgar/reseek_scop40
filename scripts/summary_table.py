...
algo2sm["devreseek-veryfast"] = get_secs_memmb("../reseek_search/devveryfast.time")
algo2sm["devreseek-fast"] = get_secs_memmb("../reseek_search/devfast.time")
algo2sm["devreseek-sensitive"] = get_secs_memmb("../reseek_search/devsensitive.time")
algo2sm["devreseek-verysensitive"] = get_secs_memmb("../reseek_search/devverysensitive.time")
# print(algo2sm)
